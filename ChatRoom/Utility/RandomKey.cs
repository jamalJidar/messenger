...
namespace Utility
{
    public static class RandomKey
    {
        ...
        private static string shorturl_chars_ucase = "zyxwtsrqpnmkjigfedcba";
        ...
        public static string RandomCharacters(int size = 5)
        {
           ...
           return       string.Join("",  (string.Join(',', alphabet.ToCharArray()) +
                         ...
                         string.Join(',', shorturl_chars_ucase.ToUpper().Reverse())
                                 ...
                                 .OrderBy(x => ran.Next(alphabet.Length * 4)).ToArray()
                                 .Take(size)
                                 .ToArray()
                                  );
         }
        ...
        public static string RandomCharacters()
        {
            ...
            char[][] charGroups = new char[][]
            {
                ...
                shorturl_chars_ucase.ToLower().ToCharArray(),
